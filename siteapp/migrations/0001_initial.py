    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copyright', models.CharField(max_length=100, verbose_name='Авторские права')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='siteapp.site', verbose_name='Сайт')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='help', to='siteapp.helpcategory', verbose_name='Категория')),
            ],
            options={
                'verbose_name': 'Помощь',
